...
/**
 * SideRays — React Bits (ogl WebGL light rays). Adapted to TypeScript.
 * CSS lives in global.css (.side-rays-container). Adds a prefers-reduced-motion
 * guard: renders a single static frame instead of the animation loop.
 */
